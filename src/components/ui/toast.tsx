...
import { cn } from "/Users/rafaelbraga/Desktop/dev-portfolio/src/lib/utils.ts";
...
const Toast = React.forwardRef<
  React.ElementRef<typeof ToastPrimitives.Root>, // correct ref type = HTMLLIElement
  ToastProps
...
const ToastAction = React.forwardRef<
  React.ElementRef<typeof ToastPrimitives.Action>, // ref = HTMLButtonElement
  ToastActionProps
>(({ className, ...props }, ref) => (
...
const ToastClose = React.forwardRef<
  React.ElementRef<typeof ToastPrimitives.Close>, // ref = HTMLButtonElement
  ToastCloseProps
>(({ className, ...props }, ref) => (
...
const ToastTitle = React.forwardRef<
  React.ElementRef<typeof ToastPrimitives.Title>, // ref = HTMLDivElement
  ToastTitleProps
>(({ className, ...props }, ref) => (
...
const ToastDescription = React.forwardRef<
  React.ElementRef<typeof ToastPrimitives.Description>, // ref = HTMLParagraphElement
